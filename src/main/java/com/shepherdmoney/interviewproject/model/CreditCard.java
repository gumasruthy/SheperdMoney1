...
public class CreditCard {
    ...
    // This means that if today is 04-16, and the list begin as empty, you receive a
    // payload for 04-13,
    ...
    // 04-16)
    // 6. In the condition that there are gaps, retrieval of "closest **previous**"
    // balance date should also be fast. Aka, given 4-15, return 4-13 entry tuple
}
